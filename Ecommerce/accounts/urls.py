...
from Ecommerce.accounts.views import Login, Register, show_navigator, show_profile_settings, DeleteProfile, \
    update_user_name, update_user_email, update_user_password
